...
// GET /api/force-login - Test login con parametri URL
  ...
  try {
    ...
    if (!email || !password) {
      return NextResponse.json({
        ...
        message: "Usa: /api/force-login?email=your-email&password=your-password",
        example: "/api/force-login?email=admin@admin.it&password=yourpassword"
      }, { status: 400 });
    }
